...
if __name__== '__main__':
  ...
  parser = argparse.ArgumentParser(description='Quantum Community Detection - Leap Hybrid')
  ...
  parser.add_argument('-label', default='qcd_leapHybrid', help='label for run')
  ...
  # Run k-clustering with LeapHybrid/D-Wave using ocean
  ss = QCD.clusterLeapHybrid(Q, num_parts, run_label, run_profile, tlimit, result)
