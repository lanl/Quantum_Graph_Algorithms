...
if __name__== '__main__':
  ...
  parser = argparse.ArgumentParser(description='Quantum Community Detection 2-clustering - Leap hybrid workflow')
  ...
  parser.add_argument('-label', default='q2cd_leapHybrid', help='label for run')
  ...
  ss = QCD.clusterLeapHybrid(B, num_nodes, nparts, run_label, run_profile, tlimit, result)
