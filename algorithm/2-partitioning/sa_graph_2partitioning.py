...
if __name__== '__main__':
  ...
  parser = argparse.ArgumentParser(description='Quantum Graph 2-Partitioning - D-Wave Direct')
  ...
  parser.add_argument('-label', default='q2gp_sa', help='label for run')
  ...
  # Run 2-partitioning usng SA
  ss = QGP.partitionSA(Q, num_nodes, result)
