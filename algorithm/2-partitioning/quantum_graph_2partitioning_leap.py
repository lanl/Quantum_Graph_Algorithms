...
if __name__== '__main__':
  ...
  parser = argparse.ArgumentParser(description='Quantum Graph 2-Partitioning - Leap hybrid workflow')
  ...
  parser.add_argument('-label', default='q2gp_leapHybrid', help='label for run')
  ...
  # Run 2-partitioning with D-Wave Leap hybrid workflow using ocean
  ss = QGP.partitionLeapHybrid(Q, num_nodes, num_parts, run_label, run_profile, tlimit, result)
