...
def partitionLeapHybrid(Q, num_nodes, num_parts, run_label, run_profile, tlimit, result):

  # Start with Q
  print('\n Q size = ', num_nodes)

  # Partition into 2 parts using LeapHybrid/DWave ocean
  ss = runDwaveLeapHybrid(Q, num_nodes, num_parts, run_label, run_profile, tlimit, result)
