...
if __name__== '__main__':
  ...
  parser.add_argument('-label', default='qgp_direct', help='label for run')
  ...
  #qsize = Q.shape[1]
  #embedding = QGP.getEmbedding(qsize, run_profile)
  #print('Embedding done')
  #print(flush=True)

  # Run k-partitioning using ocean
  #ss = QGP.partition(Q, num_parts, embedding, qsize, run_label, run_profile, result)
  ss = QGP.partition(Q, num_parts, run_label, run_profile, result)
